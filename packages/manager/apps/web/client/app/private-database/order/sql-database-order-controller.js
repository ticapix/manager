...
angular.module('App').controller(
  ...
  class SqlDatabaseOrderCtrl {
      ...
      return this.$q
        .all(map(
          ...
          duration => this.PrivateDatabase
            ...
            .then((details) => {
              find(data.durations, 'duration', duration).details = details;
              return details;
            }),
        ))
        .then(() => {
    ...
    getDurationDetails(type, duration) {
      ...
      return find(this.getData(type).durations, 'duration', duration).details;
    }
    ...
    findHosting(name) {
      return find(this.getData(this.model.type).hostings, 'name', name);
    }
