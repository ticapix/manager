...
export default class EmailOfferActivateCtrl {
  ...
  createOrder() {
    ...
    this.order = null;
    this.contractsAccepted = false;
    return this.hostingEmailService.prepareCart(
  ...
  activate() {
    ...
    return this.hostingEmailService.orderCart(
      this.order.cart,
    ).then((order) => this.goToHosting(
      this.$translate.instant(
        'hosting_email_address_activation_success',
